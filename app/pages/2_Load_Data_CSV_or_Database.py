# C:\Users\LENOVO\Desktop\Python Projects\presight_data_profiler\app\pages\2_Load_Data_CSV_or_Database.py
...
# 2. Imports that might use Streamlit functions (e.g., apply_professional_styling, create_nav_header)
# These functions should also be designed not to call st. commands before set_page_config has run.
...
# 3. Apply general styling and navigation header *after* page config
apply_professional_styling()
# create_nav_header("📂 Load Your Data", "Connect to databases or upload CSV files to begin your data analysis journey")
# You'll likely want to put create_nav_header inside main() if it uses st. components that need
# to be rendered after authentication/page setup. Or ensure it only uses st.markdown etc.

# --- Global CSS (can be here or in main) ---
st.markdown("""
<style>
    .page-header {
...
# --- Define your protected main function ---
@require_auth()
def main():
    """Protected main function for Load Data"""
